...
The file that may cause problem is "webpack.config.mjs" because it's going to be overwritten. For that reason, if you want to change it, consider creating a separate JavaScript file and include it in webpack.config.mjs. That way, when you update, you only have to restore the line that include your file.
